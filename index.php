    ...
    <div class="row justify-content-center pt-5">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">¿Necesitas agendar una cita?</h5>
              ...
              <form class="needs-validation" novalidate>
                ...
                <div class="form-row">
                  <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control" id="txtIssue" cols="30" rows="10" placeholder="Ingresa el asunto de tu cita" required></textarea>
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
